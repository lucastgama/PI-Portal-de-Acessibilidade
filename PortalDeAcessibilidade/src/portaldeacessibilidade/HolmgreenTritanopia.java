 ...
 * @author Claudinei
 */
public class HolmgreenTritanopia extends javax.swing.JPanel {
    public JDesktopPane jDesktopPane;
    public int soma = 0;
    /**
     * Creates new form OpcoesTeste3
     */
    public HolmgreenTritanopia(JDesktopPane jDesktop) {
        initComponents();
    ...
    private void btnVerificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarActionPerformed
        if (soma == 20) {
            ...
            TritResultNegativo TelaResNeg = new TritResultNegativo(jDesktopPane);
            jDesktopPane.add(TelaResNeg);
            TelaResNeg.setVisible(true);
        } else {
            jDesktopPane.removeAll();
            TritResultPositivo TelaResPos = new TritResultPositivo(jDesktopPane);
