...
public class TelaResTritNegativo extends javax.swing.JFrame {

    public TelaResTritNegativo() {
    ...
    private void initComponents() {
        ...
        lblTexto1.setText("O paciente não possui Tritanopia");
        jPanel1.add(lblTexto1);
        lblTexto1.setBounds(320, 270, 720, 56);
    ...
    public static void main(String args[]) {        
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaResTritNegativo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new TelaResTritNegativo().setVisible(true);
        });
    }
