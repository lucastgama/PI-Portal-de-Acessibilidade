...
public class HolmgreenDeuteranopia extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextPane1.setText("\tNeste teste, o paciente deverá selecionar as lãs que o mesmo determinar sendo de diferentes tonalidades da cor verde, clicando sobre os botões das respectivas lãs, ou digitando pelo teclado, da maneira que lhe for de melhor agrado.\n");
