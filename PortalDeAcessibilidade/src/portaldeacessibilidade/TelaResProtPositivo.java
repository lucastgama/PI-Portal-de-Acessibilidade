...
public class TelaResProtPositivo extends javax.swing.JFrame {

    public TelaResProtPositivo() {
    ...
    private void initComponents() {
        ...
        lblTexto1.setText("O paciente possui um nível baixo de Protanopia");
        jPanel1.add(lblTexto1);
        lblTexto1.setBounds(150, 220, 1040, 56);
    ...
    public static void main(String args[]) {        
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaResProtPositivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
