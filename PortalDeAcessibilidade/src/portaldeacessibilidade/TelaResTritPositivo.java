...
public class TelaResTritPositivo extends javax.swing.JFrame {

    public TelaResTritPositivo() {
    ...
    public static void main(String args[]) {        
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaResTritPositivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
