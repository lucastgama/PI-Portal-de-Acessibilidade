...
public class TelaResDeutPositivo extends javax.swing.JFrame {

    public TelaResDeutPositivo() {
    ...
    private void initComponents() {
        ...
        lblTexto1.setText("O paciente possui um nível baixo de Deuteranopia");
        jPanel1.add(lblTexto1);
        lblTexto1.setBounds(130, 220, 1090, 56);
    ...
    public static void main(String args[]) {        
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaResDeutPositivo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
