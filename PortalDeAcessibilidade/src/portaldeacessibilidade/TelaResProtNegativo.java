...
public class TelaResProtNegativo extends javax.swing.JFrame {

    public TelaResProtNegativo() {
    ...
    private void initComponents() {
        ...
        lblTexto1.setText("O paciente não possui Protanopia");
        jPanel1.add(lblTexto1);
        lblTexto1.setBounds(310, 270, 740, 56);
    ...
    public static void main(String args[]) {        
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaResProtNegativo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
